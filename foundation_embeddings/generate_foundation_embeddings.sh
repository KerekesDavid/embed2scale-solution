...
python3 embed_croma.py ${downstream_data_dir}/data_dev/ ${data_dir}/croma-dev-embeddings/embeddings
python3 embed_croma.py ${downstream_data_dir}/data_eval/ ${data_dir}/croma-eval-embeddings/embeddings
